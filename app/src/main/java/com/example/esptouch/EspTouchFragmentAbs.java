...
public abstract class EspTouchFragmentAbs extends Fragment {
    ...
    private void showAboutDialog() {
        ...
        CharSequence[] items = new CharSequence[]{
                getString(R.string.esptouch_about_version, appVer),
                esptouchVerText
        };
        new AlertDialog.Builder(getActivity())
                .setTitle(R.string.esptouch_menu_item_about)
    ...
    public void onCreateOptionsMenu(Menu menu, @NotNull MenuInflater inflater) {
        menu.add(Menu.NONE, MENU_ITEM_ABOUT, 0, R.string.esptouch_menu_item_about)
                .setIcon(R.drawable.ic_baseline_info_white_24)
    ...
    protected StateResult checkPermission() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            boolean locationGranted = getActivity().checkSelfPermission(Manifest.permission.ACCESS_FINE_LOCATION)
    ...
    protected StateResult checkLocation() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            LocationManager manager = getActivity().getSystemService(LocationManager.class);
